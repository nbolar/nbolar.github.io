...
<div style="width:image width px; font-size:80%; text-align:center;"><img src="{{ site.url }}{{ site.baseurl }}/images/darko_gif.mov" alt="Darko" width="width" height="480" style="padding-bottom:0.5em;" />Darko in action</div>
