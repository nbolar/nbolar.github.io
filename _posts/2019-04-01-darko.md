...
<div style="width:image width px; font-size:80%; text-align:center;"><img src="{{ site.url }}{{ site.baseurl }}/images/preview.mov" alt="Darko" width="width" height="750" style="padding-bottom:0.5em;" />Darko in action</div>
